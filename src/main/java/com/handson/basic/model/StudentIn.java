...
public class StudentIn implements Serializable {
    ...
    public Student toStudent() {
        return aStudent().withCreatedAt(Dates.nowUTC()).withBirthDate(Dates.atUtc(birthDate)).withFullname(fullname)
                .withSatScore(satScore).withGraduationScore(graduationScore)
                .withPhone(phone)
                .build();
    }
